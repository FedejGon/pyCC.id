...
##############################################
# 4) how to post-process the identified model with SymbR [pycc.post_processing()]

### Simulation using the NN models
print("simulation with NN simul")
# 4a) define simulation parameters
...
#simulate using interpolation from SymbR obtained functions
