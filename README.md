...
*Figure 2: The architecture for a second-order system with a velocity-dependent friction force. Two independent neural networks ($\text{NN}_1$ and $\text{NN}_2$) approximate the unknown CCs. $\text{NN}_1$ sees only velocity, and $\text{NN}_2$ sees only position.*
</div>
