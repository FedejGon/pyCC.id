...
params_poly_simul = {
    "models": models,                       # from train_polynomial
    "scalar_params": {'a3':2.0},#scalar_coefs,        # learned scalar a1,a2,... from train
    #"final_scalars": {'a3':2.0},
   # "atol": 1e-8,
   # "rtol": 1e-6,
    "t_span": t_span,
    "y0": y0,  # x, x_dot, x_ddot
...
sol = pycc.simulate(equations,method='Poly', params=params_poly_simul)
...
plt.plot(time_sim, x1,'--', label="x(t) simulated  Poly")
plt.xlabel('t')
plt.ylabel('x(t)')
plt.legend()
plt.show()
